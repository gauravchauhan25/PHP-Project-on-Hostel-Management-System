        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="font-size: 20px;">
                ...
                ?><br>
                    ...
                    <form method="post" action="" class="form-horizontal" onSubmit="return valid();" style="font-size: 20px;">
                        <div class="form-group mb-3">
                            <label class="mb-3 control-label"> Enrollment No : </label>
                            <div class="col-sm-8">
                        ...
                        <div class="col-12">
                            <center><button class="btn btn-primary" type="submit" name="update" style="font-size: 17px;">Update Profile</button></center><br /><br />
                        </div>
                    </form>
                <?php
                }
                ...
                <!-- <canvas class="my-4 w-100" id="myChart" width="900" height="130"></canvas> -->
