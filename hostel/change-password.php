                    ...
                    <div class=" panel-default">
                        <div class="panel-heading">
                            <div class="panel-body" style="position: relative; ">
                                <form method="post" class="form-check form" name="changepwd" id="change-pwd" onSubmit="return valid();" style="font-size: 18px;">
                                    ...
                                    <div class="col-sm-6 col-sm-offset-4 mb-3">
                                        <input type="reset" name="reset" Value="Cancel" class="btn btn-primary" style="width: 20%; padding: 8px;">
                                        <input type="submit" name="changepwd" Value="Change Password" class="btn btn-primary" style=" padding: 8px;">
                                    </div>
                                </form>
